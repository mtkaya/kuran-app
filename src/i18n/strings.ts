...
const translations: Record<LanguageCode, UIStrings> = {
    tr: {
        ...
        verseCard: 'Ayet Kartı',
        verseCardPreview: 'Kart önizlemesi',
        cardBackground: 'Arka plan',
        cardFormat: 'Format',
        cardContent: 'İçerik',
        cardFormatSquare: 'Kare',
        cardFormatPost: 'Dikey',
        cardFormatStory: 'Hikâye',
        cardTranslation: 'Meal',
        cardSignature: 'İmza',
        cardFrame: 'Çerçeve',
        cardShare: 'Paylaş',
        cardSave: 'Kaydet',
        cardSaved: 'Görsel kaydedildi',
    ...
    en: {
        ...
        verseCardPreview: 'Card preview',
        cardBackground: 'Background',
        cardFormat: 'Format',
        cardContent: 'Content',
        cardFormatSquare: 'Square',
        cardFormatPost: 'Portrait',
        cardFormatStory: 'Story',
    ...
    de: {
        ...
        drillRepeatOf: 'Wdh.',
        verseCard: 'Verskarte',
        verseCardPreview: 'Kartenvorschau',
        cardBackground: 'Hintergrund',
        cardFormat: 'Format',
        cardContent: 'Inhalt',
        cardFormatSquare: 'Quadrat',
        cardFormatPost: 'Hochformat',
        cardFormatStory: 'Story',
        cardTranslation: 'Übersetzung',
        cardSignature: 'Signatur',
        cardFrame: 'Rahmen',
        cardShare: 'Teilen',
        cardSave: 'Speichern',
        cardSaved: 'Bild gespeichert',
    ...
    fr: {
        ...
        drillStop: 'Terminer',
        drillRepeatOf: 'Rép.',
        verseCard: 'Carte de verset',
        verseCardPreview: 'Aperçu de la carte',
        cardBackground: 'Arrière-plan',
        cardFormat: 'Format',
        cardContent: 'Contenu',
        cardFormatSquare: 'Carré',
        cardFormatPost: 'Portrait',
        cardFormatStory: 'Story',
    ...
    ar: {
        ...
        verseCardPreview: 'معاينة البطاقة',
        cardBackground: 'الخلفية',
        cardFormat: 'الأبعاد',
        cardContent: 'المحتوى',
        cardFormatSquare: 'مربع',
        cardFormatPost: 'طولي',
        cardFormatStory: 'ستوري',
        cardTranslation: 'الترجمة',
        cardSignature: 'التوقيع',
        cardFrame: 'الإطار',
        cardShare: 'مشاركة',
        cardSave: 'حفظ',
        cardSaved: 'تم حفظ الصورة',
    ...
    id: {
        ...
        verseCard: 'Kartu Ayat',
        verseCardPreview: 'Pratinjau kartu',
        cardBackground: 'Latar',
        cardFormat: 'Format',
        cardContent: 'Konten',
        cardFormatSquare: 'Persegi',
        cardFormatPost: 'Potret',
        cardFormatStory: 'Story',
        cardTranslation: 'Terjemahan',
        cardSignature: 'Tanda',
        cardFrame: 'Bingkai',
        cardShare: 'Bagikan',
        cardSave: 'Simpan',
        cardSaved: 'Gambar disimpan',
    ...
    ur: {
        ...
        drillRepeatOf: 'تکرار',
        verseCard: 'آیت کارڈ',
        verseCardPreview: 'کارڈ کا پیش منظر',
        cardBackground: 'پس منظر',
        cardFormat: 'فارمیٹ',
        cardContent: 'مواد',
        cardFormatSquare: 'مربع',
        cardFormatPost: 'عمودی',
        cardFormatStory: 'اسٹوری',
        cardTranslation: 'ترجمہ',
        cardSignature: 'دستخط',
        cardFrame: 'فریم',
        cardShare: 'شیئر کریں',
        cardSave: 'محفوظ کریں',
        cardSaved: 'تصویر محفوظ ہو گئی',
    ...
    bn: {
        ...
        verseCard: 'আয়াত কার্ড',
        verseCardPreview: 'কার্ড প্রিভিউ',
        cardBackground: 'পটভূমি',
        cardFormat: 'ফরম্যাট',
        cardContent: 'বিষয়বস্তু',
        cardFormatSquare: 'বর্গাকার',
        cardFormatPost: 'উল্লম্ব',
        cardFormatStory: 'স্টোরি',
        cardTranslation: 'অনুবাদ',
        cardSignature: 'স্বাক্ষর',
        cardFrame: 'ফ্রেম',
        cardShare: 'শেয়ার',
        cardSave: 'সংরক্ষণ',
        cardSaved: 'ছবি সংরক্ষিত হয়েছে',
